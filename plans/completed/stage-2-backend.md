...
- [x] Заполнить меню через панель администратора (23 позиции, дубликаты напитков удалены, временные фото-плейсхолдеры по категориям — реальные фото блюд ещё нужны)
